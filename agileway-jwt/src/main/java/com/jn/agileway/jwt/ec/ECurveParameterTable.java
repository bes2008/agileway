 ...
 */
public class ECurveParameterTable {
     ...
     *         determined.
     */
    public static ECParameterSpec get(final ECurve curve) {
        if (ECurves.P_256.equals(curve)) {
            return P_256_SPEC;
        } else if (ECurves.SECP256K1.equals(curve)) {
            return SECP256K1_SPEC;
        } else if (ECurves.P_384.equals(curve)) {
            return P_384_SPEC;
        } else if (ECurves.P_521.equals(curve)) {
            return P_521_SPEC;
        } else {
            return null;
        }
     ...
     *         determined.
     */
    public static ECurve get(final ECParameterSpec spec) {
