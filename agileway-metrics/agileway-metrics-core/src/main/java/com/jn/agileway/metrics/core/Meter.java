...
public interface Meter {
    ...
    class Id {
        ...
        public Id withTag(Statistic statistic) {
            return withTag(new ImmutableTag("statistic", statistic.getTagValueRepresentation()));
        }
         ...
         * generated by {@literal HistogramGauges} are derivatives of a {@link Timer} or
    ...
    class Builder {
        ...
        public Meter register(MeterRegistry registry) {
            return registry.register(new Id(name, tags, baseUnit, description, type), type, measurements);
        }
