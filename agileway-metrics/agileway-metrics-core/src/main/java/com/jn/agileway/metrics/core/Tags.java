...
public final class Tags implements Iterable<Tag> {
    ...
    public Tags and(String key, String value) {
        return and(new ImmutableTag(key, value));
    }
     ...
     * @return a new {@code Tags} instance
     */
    public Tags and(@Nullable Iterable<Tag> tags) {
     ...
     */
    public static Tags concat(@Nullable Iterable<Tag> tags, @Nullable Iterable<Tag> otherTags) {
     ...
     * @return the merged tags
     */
    public static Tags concat(@Nullable Iterable<Tag> tags, @Nullable String... keyValues) {
     ...
     * @return a new {@code Tags} instance
     */
    public static Tags of(@Nullable Iterable<Tag> tags) {
        if (tags == null || tags == EMPTY || !tags.iterator().hasNext()) {
            return Tags.empty();
        }
            ...
            return new Tags(Pipeline.of(tags).toArray(Tag[].class));
        }
    }
    ...
    public static Tags of(String key, String value) {
        return new Tags(new Tag[] { new ImmutableTag(key, value) });
    }
    ...
    public static Tags of(@Nullable String... keyValues) {
        ...
        for (int i = 0; i < keyValues.length; i += 2) {
            tags[i / 2] = new ImmutableTag(keyValues[i], keyValues[i + 1]);
        }
    ...
    public String toString() {
        return Strings.join(",","[","]", false, this.iterator());
    }
