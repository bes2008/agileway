...
public class MultiGauge {
    ...
    public static class Row<T> {
        ...
        private final com.jn.agileway.metrics.core.Tags uniqueTags;

        private final T obj;

        private final ToDoubleFunction<T> valueFunction;

        private Row(com.jn.agileway.metrics.core.Tags uniqueTags, T obj, ToDoubleFunction<T> valueFunction) {
            this.uniqueTags = uniqueTags;
            this.obj = obj;
            this.valueFunction = valueFunction;
        }

        public static <T> Row<T> of(com.jn.agileway.metrics.core.Tags uniqueTags, T obj, ToDoubleFunction<T> valueFunction) {
            return new Row<>(uniqueTags, obj, valueFunction);
        }

        public static Row<Number> of(com.jn.agileway.metrics.core.Tags uniqueTags, Number number) {
            return new Row<>(uniqueTags, number, Number::doubleValue);
        }

        public static Row<Supplier<Number>> of(com.jn.agileway.metrics.core.Tags uniqueTags, Supplier<Number> valueFunction) {
