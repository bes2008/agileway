...
public interface TimeGauge extends Gauge {
    ...
    class Builder<T> {
        ...
        public TimeGauge register(MeterRegistry registry) {
            return registry.more().timeGauge(new Id(name, tags, null, description, Type.GAUGE), obj, fUnits,
                    strongReference ? new com.jn.agileway.metrics.core.StrongReferenceGaugeFunction<>(obj, f) : f);
        }
