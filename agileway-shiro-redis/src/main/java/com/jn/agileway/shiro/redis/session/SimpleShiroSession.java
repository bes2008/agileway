...
public class SimpleShiroSession implements ValidatingSession {
    ...
    public void validate() throws InvalidSessionException {
        ...
        if (isTimedOut()) {
            ...
            String msg = "Session with id [" + sessionId + "] has expired. " +
                    ...
                    ".  Session timeout is set to " + timeout / SECONDS_TO_MILLIS + " seconds (" +
                    timeout / SECONDS_TO_MILLIS + " minutes)";
            if (logger.isTraceEnabled()) {
                logger.trace(msg);
            }
     ...
     * does not yet have an ID assigned, the value of {@link #onEquals(SimpleShiroSession) onEquals} is returned, which
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SimpleShiroSession) {
            SimpleShiroSession other = (SimpleShiroSession) obj;
     ...
     * @since 1.1.0
     */
    protected boolean onEquals(SimpleShiroSession ss) {
