...
public class DefaultHttpExchangeMethodResolver implements HttpExchangeMethodResolver {
    ...
    private void resolveResponseType(HttpExchangeMethod exchangeMethod, Method javaMethod) {
