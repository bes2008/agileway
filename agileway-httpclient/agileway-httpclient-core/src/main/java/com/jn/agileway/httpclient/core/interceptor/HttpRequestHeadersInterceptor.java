...
import com.jn.agileway.httpclient.core.multipart.MultiPartsContent;
    ...
    private void handleContentTypeAndLength(HttpRequest request) {
        ...
        switch (method) {
            ...
            default:
                if (request.getContent() == null) {
                    request.getHeaders().setContentLength(0L);
                } else if (request.getContent() instanceof MultiPartsContent || request.getContent() instanceof Resource) {
